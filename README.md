...
1. Refactor the monstrous code in the `GildedRose.java` class.
2. Add a new item type, "Conjured". The specs for this item are commented out in the `GildedRoseTest.java` file.
